...
public struct Schema: Sendable {
    ...
    /// Raw CREATE TRIGGER texts keyed by name. The catalog persists only the text
    /// (like SQLite's `sqlite_schema`); the SQL layer parses it on demand.
    public var triggerTexts: [String: String]

...
struct BenchConfig {
    ...
    /// ``realSQLitePath``). — the 4 GB apple-docs measurement.
    ...
    /// pre-built ADSQL database whose `documents` carries the denorm columns
    ...
    /// decisive "does cross SQLite at real scale" arm.

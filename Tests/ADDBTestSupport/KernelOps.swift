...
enum KernelOps {
    static func put(_ ctx: TxnContext, _ key: [UInt8], _ value: [UInt8]) throws {
        var failure: DBError?
    ...
    @discardableResult
    static func delete(_ ctx: TxnContext, _ key: [UInt8]) throws -> Bool {
    ...
    static func apply(_ op: DBOp, ctx: TxnContext, model: inout ModelStore) throws {
        switch op {

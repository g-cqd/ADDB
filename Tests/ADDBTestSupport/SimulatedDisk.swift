...
/// groups vanish.
final class SimulatedDisk: StorageChannel, @unchecked Sendable {
    enum Mutation {
    ...
    init(path: String) throws(DBError) {
    ...
    func fileSize() throws(DBError) -> Int { try inner.fileSize() }
    ...
    func materializeCrashImage(cutGroup: Int, tearSeed: UInt64) -> [UInt8] {
    ...
    func writeCrashImage(_ image: [UInt8], to path: String) throws(DBError) {
